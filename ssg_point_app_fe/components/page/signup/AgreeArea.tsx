      ...
      <div className={styles.cnt_box0}>
        <div className={`${styles.join_agree_box} ${styles.check_box_js}`}>
          ...
          <ul className={`${styles.agree_list} ${styles.btn_type0} ${styles.txt_type0}`}>
            ...
            <li className={styles.agree_form}>
              <div className={styles.chk_box}>
                <input type="checkbox" id="terms104001704" className={`${styles.check_list_js} ${styles.optional_list}`} name='agree1' onChange={handleOnChange} />
            ...
            <li className={styles.agree_form}>
              <div className={styles.chk_box}>
                <input type="checkbox" id="terms104001705" className={`${styles.check_list_js} ${styles.optional_list}`} name='agree2' onChange={handleOnChange} />
